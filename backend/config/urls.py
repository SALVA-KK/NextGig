...
urlpatterns = [
    ...
    path("api/admin/users/<int:pk>/detail/", AdminUserDetailView.as_view(), name="admin-user-detail"),
    path("api/admin/users/<int:pk>/toggle-active/", AdminToggleUserActiveView.as_view(), name="admin-toggle-user-active"),
    path("api/admin/users/<int:pk>/", AdminDeleteUserView.as_view(), name="admin-user-delete"),
